...
import { apiResultFormat, breadCrumbItems, callHistory } from '../../../../shared/models/models';
...
export class CallHistoryComponent {
  ...
  public tableDataCopy:  callHistory[] = [];
  public actualData:  callHistory[] = [];
...
private getTableData(pageOption: pageSelection): void {
  this.data.getcallHistory().subscribe((apiRes: apiResultFormat) => {
    ...
    this.dataSource = new MatTableDataSource< callHistory>(this.actualData);
