...
import { apiResultFormat, attendanceadmin, breadCrumbItems } from '../../../../shared/models/models';
...
export class AttendanceAdminComponent {
  ...
  public pageSize = 10;
  public tableData:  attendanceadmin[] = [];
  public tableDataCopy:  attendanceadmin[] = [];
  public actualData:  attendanceadmin[] = [];
  ...
  dataSource!: MatTableDataSource< attendanceadmin>;
...
private getTableData(pageOption: pageSelection): void {
  this.data.getattendanceadmin().subscribe((apiRes: apiResultFormat) => {
    ...
    apiRes.data.map((res:  attendanceadmin, index: number) => {
    ...
    this.dataSource = new MatTableDataSource< attendanceadmin>(this.actualData);
