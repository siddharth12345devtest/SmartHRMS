...
import { apiResultFormat, breadCrumbItems, department } from '../../../../shared/models/models';
...
export class DepartmentsComponent {
  ...
  public pageSize = 10;
  public tableData: department[] = [];
  public tableDataCopy: department[] = [];
  public actualData: department[] = [];
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getdepartments().subscribe((apiRes: apiResultFormat) => {
      ...
      apiRes.data.map((res: department, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<department>(this.actualData);
